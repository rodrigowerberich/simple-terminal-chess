...
MoveProposalAnalysis::MoveProposalAnalysis(const Chess::Board::Board& board, Chess::Rules::MovementInterrupted movementInterrupted):m_board{board}, m_type{MoveProposalAnalysis::Type::MovementInterrupted}, m_info{movementInterrupted}{  
}
...
template<>
const Chess::Rules::MovementInterrupted& MoveProposalAnalysis::info(){
    return m_info.movementInterrupted;
}
